...
Sign Up
      ...
      <input type="text" className="text-[#000] border-[2px] rounded font-bold pl-[0.5rem] username" name="userName" placeholder="Username" autoComplete="off" value={userData.userName} onChange={handleChange} />
      <span className="text-[red]">{warn.userName}</span>
      <input type="text" className="text-[#000] border-[2px] rounded font-bold pl-[0.5rem] email" name="email" placeholder="Email" autoComplete="off" value={userData.email} onChange={handleChange} />
      <span className="text-[red]">{warn.email}</span>
      <input type="text" className="text-[#000] border-[2px] rounded font-bold pl-[0.5rem] number" name="number" placeholder="Phone number" autoComplete="off" value={userData.number} onChange={handleChange} />
      <span className="text-[red]">{warn.number}</span>
      <input type="text" className="text-[#000] border-[2px] rounded font-bold pl-[0.5rem] creat-pass" name="createPass" placeholder="Create password" autoComplete="off" value={userData.createPass} onChange={handleChange} />
      <span className="text-[red]">{warn.createPass}</span>
      <input type="text" className="text-[#000] border-[2px] rounded font-bold pl-[0.5rem] confirm-pass" name="confirmPass" placeholder="Confirm password" autoComplete="off" value={userData.confirmPass} onChange={handleChange} />
      <span className="text-[red]">{warn.confirmPass}</span>
    </div>
    </fieldset>
      <button type="submit" className="w-[5rem] rounded my-[0] mx-[auto] py-[0.4rem] text-white font-bold text-center block mt-[1rem] bg-[#00A4FF]">Sign Up</button>
    </form>
    </div>
  )
}
